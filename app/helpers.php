...
//    throw_when($person_not_allowed_is_true, 'Person is not allowed');
...
//class_basename(App\Http\Controllers\WelcomeController::class) === "WelcomeController"
...
//        ]
//    ];
//    data_set($person, 'family.cousin.name' , 'Timmy');
//    data_get($person, 'family.cousin.name'); == 'Timmy'
//    works on objects as well, $person->family->cousin
